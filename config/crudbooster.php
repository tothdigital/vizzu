...
return [
    ...
    */
    ...
    'PHONE_FIELDS_CANDIDATE' => 'phone,phonenumber,phone_number,telp,hp,no_hp,no_telp,telefone,celular,fone',

    'NAME_FIELDS_CANDIDATE' => 'name,nome,nama,person_name,person,fullname,full_name,nickname,nick,nick_name,title,judul,content',
