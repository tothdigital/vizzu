<?php namespace App\Http\Controllers;
	...
	class AdminVizzuCategoriasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
	        ...
	        $columns[] = ['label'=>'Nome da SubCategoria','name'=>'nome','type'=>'text'];
